...
const required = ['README.md', 'LICENSE', 'THIRD-PARTY-NOTICES.md', 'package.json', 'package-lock.json', 'src/server.js', 'src/advanced-tools.js', 'setup.cmd', 'src/setup.js', 'src/wxlens-runtime.js', 'docs/first-use.md', 'docs/monitoring.md', 'docs/optional-runtime.md']
